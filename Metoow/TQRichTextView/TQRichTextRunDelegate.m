...
{
    CTFontRef ctf = (__bridge CTFontRef)(self.font);
    return CTFontGetAscent(ctf);
    return self.font.ascender;      //IOS6 crash
}

- (CGFloat)richTextRunGetDescent
{
    CTFontRef ctf = (__bridge CTFontRef)(self.font);
    return -CTFontGetDescent(ctf);
    return self.font.descender;     //IOS6 crash
}

- (CGFloat)richTextRunGetWidth
{
    return [self richTextRunGetAscent] - [self richTextRunGetDescent];
}

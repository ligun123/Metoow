...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    if ([HWDevice isIphone5]) {
        self.mainStoryBoard = [UIStoryboard storyboardWithName:@"MainP5" bundle:nil];
    } else {
        self.mainStoryBoard = [UIStoryboard storyboardWithName:@"MainP5" bundle:nil];
    }
    self.tabBarController = [[AppDelegateInterface mainStoryBoard] instantiateInitialViewController];
